  ...
  return (
    <footer className="bg-black text-white py-16">
      <div className="container max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="mt-8">
              ...
              <p>Torvgata 13, 2000 Lillestrøm</p>
            </div>
            
            <div>
              <p className="font-bold mb-2">Contact:</p>
              <a href="tel:+4795752185" className="hover:underline">(+47) 95 75 21 85</a>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4">
              <li><Link href="#" className="hover:underline">Join Us</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="#" className="hover:underline">Blog posts</Link></li>
              <li><Link href="#" className="hover:underline">Events calendar</Link></li>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="#" className="text-gray-400 hover:text-white">Cookies Settings</Link>
          </div>
        </div>
      </div>
    </footer>
